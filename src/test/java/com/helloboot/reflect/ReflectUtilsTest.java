...
import com.helloboot.util.reflect.ReflectUtils;
...
public class ReflectUtilsTest {
    ...
    public void field() {
        ...
        assertEquals((Integer) 1, ReflectUtils.reflect(test1).field("I_INT1").get());

        ReflectUtils.reflect(test1).field("I_INT2", 1);
        assertEquals((Integer) 1, ReflectUtils.reflect(test1).field("I_INT2").get());
        ...
        assertEquals((Integer) 1, ReflectUtils.reflect(Test1.class).field("S_INT1").get());

        ReflectUtils.reflect(Test1.class).field("S_INT2", 1);
        assertEquals((Integer) 1, ReflectUtils.reflect(Test1.class).field("S_INT2").get());
        ...
        assertEquals((Integer) 1, ReflectUtils.reflect(test2).field("invisibleField1").get());

        ReflectUtils.reflect(test2).field("invisibleField2", 1);
        assertEquals((Integer) 1, ReflectUtils.reflect(test2).field("invisibleField2").get());

        ReflectUtils.reflect(test2).field("invisibleField3", 1);
        assertEquals((Integer) 1, ReflectUtils.reflect(test2).field("invisibleField3").get());

        ReflectUtils.reflect(test2).field("visibleField1", 1);
        assertEquals((Integer) 1, ReflectUtils.reflect(test2).field("visibleField1").get());

        ReflectUtils.reflect(test2).field("visibleField2", 1);
        assertEquals((Integer) 1, ReflectUtils.reflect(test2).field("visibleField2").get());

        ReflectUtils.reflect(test2).field("visibleField3", 1);
        assertEquals((Integer) 1, ReflectUtils.reflect(test2).field("visibleField3").get());
    }
    ...
    public void fieldFinal() {
        ...
        assertEquals((Integer) 1, ReflectUtils.reflect(test11).field("F_INT1").get());

        ReflectUtils.reflect(test11).field("F_INT2", 1);
        assertEquals((Integer) 1, ReflectUtils.reflect(test11).field("F_INT2").get());
        ...
        assertEquals((Integer) 1, ReflectUtils.reflect(Test8.class).field("SF_INT1").get());

        ReflectUtils.reflect(Test8.class).field("SF_INT2", 1);
        assertEquals((Integer) 1, ReflectUtils.reflect(Test8.class).field("SF_INT2").get());
    ...
    public void fieldPrivateStaticFinal() {
        ...
        assertEquals((Integer) 1, ReflectUtils.reflect(TestPrivateStaticFinal.class).field("I2").get());

        ReflectUtils.reflect(TestPrivateStaticFinal.class).field("I1", 2);
        ReflectUtils.reflect(TestPrivateStaticFinal.class).field("I2", 2);

        assertEquals((Integer) 2, ReflectUtils.reflect(TestPrivateStaticFinal.class).field("I1").get());
        assertEquals((Integer) 2, ReflectUtils.reflect(TestPrivateStaticFinal.class).field("I2").get());
    }
