...
public class MysqlGenerator {
    ...
    private static String packageName = "helloboot";
    private static String path = "/Users/lujianhao/helloboot";       //文件路径

    private static String authorName = "lujianhao";                  //作者
    ...
    public static void main(String[] args) {
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                ...
                new DataSourceConfig()
                        ...
                        .setUrl("jdbc:mysql://127.0.0.1:3306/fastdemo?characterEncoding=utf8")
        ).setStrategy(
                // 策略配置
                new StrategyConfig()
                        ...
                        // 自定义 controller 父类
                        // .setSuperControllerClass("com.lujh." + packageName + ".controller.AbstractController")
